...
KERN_DATASET_PATH = "RNN-LSTMchina4files_DL\\china"
SAVE_DIR = "RNN-LSTMchina4files_DL\\dataset"
#it will be saved in the current directory that is open (working on)
SINGLE_FILE_DATASET = "RNN-LSTMchina4files_DL\\file_dataset"
MAPPING_PATH = "RNN-LSTMchina4files_DL\\mapping.json"
