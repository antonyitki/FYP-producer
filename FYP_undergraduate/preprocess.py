...
import json
import os
# pip install music 21
# converting tool for simbolic music data. different formats: MIDI, kern, MusicXML...
# https://web.mit.edu/music21/doc/
import music21 as m21
#for the one-hot encode (TF for output prediction(next note))
import tensorflow.keras as keras
import numpy as np


KERN_DATASET_PATH = "Music_generation\\RNN-LSTMgerman_guy\\deutschl\\erk"
SAVE_DIR = "Music_generation\\RNN-LSTMgerman_guy\\dataset"
#it will be saved in the current directory that is open (working on)
SINGLE_FILE_DATASET = "file_dataset"
MAPPING_PATH = "code\\mapping.json"
