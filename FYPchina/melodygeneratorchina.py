...
from preprocesschina import SEQUENCE_LENGTH, MAPPING_PATH
import numpy as np
import music21 as m21


class MelodyGenerator:
    def __init__(self, model_path = "modelchina.h5"):
...
if __name__== "__main__":
    ...
    melody = mg.generate_melody(seedCHINA, 700, SEQUENCE_LENGTH, 0.19)
