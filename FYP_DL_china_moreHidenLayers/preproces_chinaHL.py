...
KERN_DATASET_PATH = "chinaHidenLayers\china"
SAVE_DIR = "chinaHidenLayers\\dataset"
#it will be saved in the current directory that is open (working on)
SINGLE_FILE_DATASET = "chinaHidenLayers\\file_dataset"
MAPPING_PATH = "chinaHidenLayers\\mapping.json"
